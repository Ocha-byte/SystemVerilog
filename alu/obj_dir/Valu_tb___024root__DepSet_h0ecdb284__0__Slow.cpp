...
VL_ATTR_COLD void Valu_tb___024root___ctor_var_reset(Valu_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->alu_tb__DOT__sel = VL_RAND_RESET_I(4);
    vlSelf->alu_tb__DOT__rs1 = VL_RAND_RESET_I(8);
    vlSelf->alu_tb__DOT__rs2 = VL_RAND_RESET_I(8);
    vlSelf->alu_tb__DOT__rd = VL_RAND_RESET_I(8);
    }
