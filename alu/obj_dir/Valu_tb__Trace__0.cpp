...
void Valu_tb___024root__trace_chg_0_sub_0(Valu_tb___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelfRef.alu_tb__DOT__sel),4);
    bufp->chgCData(oldp+1,(vlSelfRef.alu_tb__DOT__rs1),8);
    bufp->chgCData(oldp+2,(vlSelfRef.alu_tb__DOT__rs2),8);
    bufp->chgCData(oldp+3,(vlSelfRef.alu_tb__DOT__rd),8);
}
