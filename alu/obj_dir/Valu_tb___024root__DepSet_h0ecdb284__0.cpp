...
VL_INLINE_OPT void Valu_tb___024root___act_sequent__TOP__0(Valu_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.alu_tb__DOT__rd = (0xffU & ((8U & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                           ? ((4U & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                               ? 0U
                                               : ((2U 
                                                   & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                                   ? 0U
                                                   : 
                                                  ((1U 
                                                    & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                                    ...
                                                    : 
                                                   (~ 
                                                    ((IData)(vlSelfRef.alu_tb__DOT__rs1) 
                                                     ^ (IData)(vlSelfRef.alu_tb__DOT__rs2))))))
                                           : ((4U & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                               ? ((2U 
                                                   & (IData)(vlSelfRef.alu_tb__DOT__sel))
                                                   ? 
