...
void Valu_tb___024root__trace_decl_types(VerilatedFst* tracep);

void Valu_tb___024root__trace_init_top(Valu_tb___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Valu_tb::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Valu_tb::trace()' called on non-VerilatedFstC object;"
