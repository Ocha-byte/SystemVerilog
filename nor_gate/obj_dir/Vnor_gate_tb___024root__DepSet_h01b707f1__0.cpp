...
VL_INLINE_OPT VlCoroutine Vnor_gate_tb___024root___eval_initial__TOP__Vtiming__0(Vnor_gate_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnor_gate_tb___024root___eval_initial__TOP__Vtiming__0\n"); );
    Vnor_gate_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
    // Body
    vlSelfRef.nor_gate_tb__DOT__in1 = 0U;
    vlSelfRef.nor_gate_tb__DOT__in2 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "nor_gate_tb.sv", 
                                         18);
    vlSelfRef.nor_gate_tb__DOT__in1 = 1U;
    vlSelfRef.nor_gate_tb__DOT__in2 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "nor_gate_tb.sv", 
                                         21);
    vlSelfRef.nor_gate_tb__DOT__in1 = 0U;
    vlSelfRef.nor_gate_tb__DOT__in2 = 1U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "nor_gate_tb.sv", 
                                         24);
    vlSelfRef.nor_gate_tb__DOT__in1 = 1U;
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "nor_gate_tb.sv", 
                                         27);
    VL_FINISH_MT("nor_gate_tb.sv", 28, "");
...
void Vnor_gate_tb___024root___eval_triggers__act(Vnor_gate_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnor_gate_tb___024root___eval_triggers__act\n"); );
    Vnor_gate_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
