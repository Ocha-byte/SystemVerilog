...
VL_ATTR_COLD void Vnot_gate_tb___024unit___ctor_var_reset(Vnot_gate_tb___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vnot_gate_tb___024unit___ctor_var_reset\n"); );
