...
VL_INLINE_OPT VlCoroutine Vxnor_gate_tb___024root___eval_initial__TOP__Vtiming__0(Vxnor_gate_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxnor_gate_tb___024root___eval_initial__TOP__Vtiming__0\n"); );
    Vxnor_gate_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
    // Body
    vlSelfRef.xnor_gate_tb__DOT__in1 = 0U;
    vlSelfRef.xnor_gate_tb__DOT__in2 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "xnor_gate_tb.sv", 
                                         18);
    vlSelfRef.xnor_gate_tb__DOT__in1 = 1U;
    vlSelfRef.xnor_gate_tb__DOT__in2 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "xnor_gate_tb.sv", 
                                         21);
    vlSelfRef.xnor_gate_tb__DOT__in1 = 0U;
    vlSelfRef.xnor_gate_tb__DOT__in2 = 1U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "xnor_gate_tb.sv", 
                                         24);
    vlSelfRef.xnor_gate_tb__DOT__in1 = 1U;
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "xnor_gate_tb.sv", 
                                         27);
    VL_FINISH_MT("xnor_gate_tb.sv", 28, "");
...
void Vxnor_gate_tb___024root___eval_triggers__act(Vxnor_gate_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vxnor_gate_tb___024root___eval_triggers__act\n"); );
    Vxnor_gate_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
