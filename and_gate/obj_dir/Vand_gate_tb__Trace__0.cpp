...
void Vand_gate_tb___024root__trace_chg_0_sub_0(Vand_gate_tb___024root* vlSelf, VerilatedFst::Buffer* bufp);
...
void Vand_gate_tb___024root__trace_chg_0_sub_0(Vand_gate_tb___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelfRef.and_gate_tb__DOT__in1));
    bufp->chgBit(oldp+1,(vlSelfRef.and_gate_tb__DOT__in2));
    bufp->chgBit(oldp+2,(((IData)(vlSelfRef.and_gate_tb__DOT__in1) 
