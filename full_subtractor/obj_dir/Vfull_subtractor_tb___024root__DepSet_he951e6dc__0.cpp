...
VL_INLINE_OPT VlCoroutine Vfull_subtractor_tb___024root___eval_initial__TOP__Vtiming__0(Vfull_subtractor_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_subtractor_tb___024root___eval_initial__TOP__Vtiming__0\n"); );
    Vfull_subtractor_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
    // Body
    vlSelfRef.full_subtractor_tb__DOT__in1 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in2 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in3 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
                                         22);
    vlSelfRef.full_subtractor_tb__DOT__in1 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in2 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in3 = 1U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
                                         27);
    vlSelfRef.full_subtractor_tb__DOT__in1 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in2 = 1U;
    vlSelfRef.full_subtractor_tb__DOT__in3 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
                                         32);
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
                                         37);
    vlSelfRef.full_subtractor_tb__DOT__in1 = 1U;
    vlSelfRef.full_subtractor_tb__DOT__in2 = 0U;
    vlSelfRef.full_subtractor_tb__DOT__in3 = 0U;
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
    ...
    co_await vlSelfRef.__VdlySched.delay(1ULL, nullptr, 
                                         "full_subtractor_tb.sv", 
                                         57);
    VL_FINISH_MT("full_subtractor_tb.sv", 59, "");
...
void Vfull_subtractor_tb___024root___eval_triggers__act(Vfull_subtractor_tb___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfull_subtractor_tb___024root___eval_triggers__act\n"); );
    Vfull_subtractor_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
