...
VL_INLINE_OPT void Vfull_adder_tb___024root___act_sequent__TOP__0(Vfull_adder_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.full_adder_tb__DOT__Sum = (((IData)(vlSelfRef.full_adder_tb__DOT__in1) 
                                          ^ (IData)(vlSelfRef.full_adder_tb__DOT__in2)) 
                                         ^ (IData)(vlSelfRef.full_adder_tb__DOT__in3));
    vlSelfRef.full_adder_tb__DOT__Cout = (((IData)(vlSelfRef.full_adder_tb__DOT__in1) 
                                           & (IData)(vlSelfRef.full_adder_tb__DOT__in2)) 
                                          | (((IData)(vlSelfRef.full_adder_tb__DOT__in1) 
                                              ^ (IData)(vlSelfRef.full_adder_tb__DOT__in2)) 
                                             & (IData)(vlSelfRef.full_adder_tb__DOT__in3)));
}
...
#endif
            VL_FATAL_MT("full_adder_tb.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("full_adder_tb.sv", 3, "", "Active region did not converge.");
            }
