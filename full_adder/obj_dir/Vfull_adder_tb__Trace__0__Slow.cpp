...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_init_sub__TOP__0(Vfull_adder_tb___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_init_top(Vfull_adder_tb___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_const_0(void* voidSelf, VerilatedFst::Buffer* bufp);
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_full_0(void* voidSelf, VerilatedFst::Buffer* bufp);
...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_register(Vfull_adder_tb___024root* vlSelf, VerilatedFst* tracep) {
...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_full_0_sub_0(Vfull_adder_tb___024root* vlSelf, VerilatedFst::Buffer* bufp);
...
VL_ATTR_COLD void Vfull_adder_tb___024root__trace_full_0_sub_0(Vfull_adder_tb___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.full_adder_tb__DOT__in1));
    bufp->fullBit(oldp+2,(vlSelfRef.full_adder_tb__DOT__in2));
    bufp->fullBit(oldp+3,(vlSelfRef.full_adder_tb__DOT__in3));
    bufp->fullBit(oldp+4,(vlSelfRef.full_adder_tb__DOT__Sum));
    bufp->fullBit(oldp+5,(vlSelfRef.full_adder_tb__DOT__Cout));
}
