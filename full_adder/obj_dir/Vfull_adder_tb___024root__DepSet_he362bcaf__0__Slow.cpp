...
#endif
            VL_FATAL_MT("full_adder_tb.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfull_adder_tb___024root___ctor_var_reset(Vfull_adder_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->full_adder_tb__DOT__in1 = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__in2 = VL_RAND_RESET_I(1);
    vlSelf->full_adder_tb__DOT__in3 = VL_RAND_RESET_I(1);
