...
void Vfull_adder_tb___024root__trace_decl_types(VerilatedFst* tracep);

void Vfull_adder_tb___024root__trace_init_top(Vfull_adder_tb___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vfull_adder_tb::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vfull_adder_tb::trace()' called on non-VerilatedFstC object;"
